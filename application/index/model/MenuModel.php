...
class MenuModel extends Model
{
    ...
    public function getfenlei($data,$page,$pageSize)
    {
        $offset = ($page - 1) * $pageSize;
        $ret = Db::table('fenlei')->where($data)
            ->limit($offset,$pageSize)->order('fenlei')->select();
        return $ret;
    }

    public function fenlei($data)
    {
        $ret = Db::table('fenlei')->count();
        return $ret;
    }
    ...
    public function getwodeshangpin($data,$page,$pageSize,$dat)
    {
        ...
        $offset = ($page - 1) * $pageSize;
        $ret = Db::table('think_shangpin')->where('user_name',$dat)->where("shuliang",'>',0)
            ->limit($offset,$pageSize)->order('shangpin_id')->select();
        return $ret;
    }
    ...
    {
        $ret = Db::table('think_shangpin')->where('user_name',$dat)->where("shuliang",'>',0)->count();
        return $ret;
    }
    ...
    public function deletefenlei($menu_id)
    {
        $ret = Db::table('fenlei')->where('fenlei',$menu_id)->delete();
        return $ret;
    }
    ...
    {
        $ret = Db::table('think_shangpin')->where($data)->where('yesno',0)->where('shenhe',"未审核")->count();
        return $ret;
    }
    ...
    {
        $offset = ($page - 1) * $pageSize;
        $ret = Db::table('think_shangpin')->where($data)->where('yesno',0)->where('shenhe',"未审核")
            ->limit($offset,$pageSize)->order('shangpin_id')->select();
        return $ret;
    }
